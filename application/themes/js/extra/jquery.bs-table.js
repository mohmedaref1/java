...
jQuery(document).ready(function () {
    ...
    // =================================================================
    var $table = jQuery('#demo-custom-toolbar'), $remove = jQuery('#demo-delete-row');
    ...
    $remove.click(function () {
        var ids = jQuery.map($table.bootstrapTable('getSelections'), function (row) {
            return row.id
        });
