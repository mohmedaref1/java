!function (t) {
    ...
    function e(t) {
        var i = t.data("settings"), e = t.children().first(), n = Math.abs(-t.css(i.direction).replace("px", "").replace("auto", "0") - e.outerWidth(!0)), i = t.data("settings"), r = 1e3 * n / i.speed, s = {};
        return s[i.direction] = t.css(i.direction).replace("px", "").replace("auto", "0") - n, {css: s, time: r}
    }
    ...
    function s(i, e, n) {
        ...
        t.get(i, function (i) {
            ...
            s.find("item").each(function () {
                var i = t(this), e = {title: i.find("title").text(), link: i.find("link").text()};
    ...
    function a(i) {
        ...
        if (i.children("li").each(function () {
            ...
            }), n < i.parent().width() || 1 == i.children().length)if (e.duplicate)for (itemWidth = Math.max.apply(Math, i.children().map(function () {
            return t(this).width()
    ...
    var c = function () {
        var t = document.createElement("p").style, i = ["ms", "O", "Moz", "Webkit"];
        ...
        init: function (e) {
            ...
            if ("reset" == e)s.html(i), s.css(c.direction, "0"), a(s); else if ("swap" == e) {
