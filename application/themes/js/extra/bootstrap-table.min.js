...
!function (a) {
    ...
    p.DEFAULTS = {
        ...
        iconsPrefix: "fa",
        icons: {
            paginationSwitchDown: "fa-angle-up icon-chevron-down",
            paginationSwitchUp: "fa-angle-down icon-chevron-up",
        ...
        })), this.options.search && (f = [], f.push('<div class="pull-' + this.options.searchAlign + ' search">', c('<input style="width: 250px;padding: 7px 10px 10px 10px;border: 0px;cursor: auto;color: #25c2f5;background-color: rgb(32, 33, 38);" class="form-control' + c(" input-%s", this.options.iconSize) + '" type="text" placeholder="%s">', this.options.formatSearch()), "</div>"), this.$toolbar.append(f.join("")), d = this.$toolbar.find(".search input"), d.off("keyup drop").on("keyup drop", function (b) {
